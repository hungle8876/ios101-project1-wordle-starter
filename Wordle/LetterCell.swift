...
class LetterCell: UICollectionViewCell {
    ...
    func set(style: LetterCellStyle) {
        ...
        case .initial:
            ...
            layer.borderColor = UIColor.gray.cgColor
        case .incorrect:
            // Set background and border color to RGBA value of 0.23, 0.23, 0.24, 1.0
        ...
        case .correctLetterOnly:
            // Set background and border color to RGBA value of 0.69, 0.63, 0.30, 1.0
        ...
        case .correctLetterAndPosition:
            // Set background and border color to RGBA value of 0.38, 0.55, 0.33, 1.0
